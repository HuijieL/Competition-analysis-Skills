...
如果巴西平台结果不足，补充搜索全球平台（Amazon.com、YouTube 评测等）。注意，每个来源评价都要附上真实可验证链接。
...
**解读方法论：**
- **费曼技巧**：假装给一个聪明但非技术背景的朋友讲，讲不清就说明没理解透（可以参考我给你的reference）
...
使用 Mermaid 绘制产品在竞争格局中的位置：注意使用flowchart。
...
### 4.3 三大场景定位：按照明星场景，心动场景，挽回场景来定义该产品
...
使用mermaid flowchart， 将产品的主要卖点，分别按照5A行为链路和三大场景分类展开，让我更加明白，该产品的营销卖点该如何排布。
